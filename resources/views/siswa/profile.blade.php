...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Profil Siswa') }}</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card-profile-stats">
                                ...
                                <span class="description">Kode Siswa</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card-profile-stats">
                                <span class="heading">89</span>
                                <span class="description">Nomor Siswa</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="email">Akun Email<span class="small text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="ml-4">Note : Password Tidak Bisa Diubah, Jika ada masalah hubungi Admin.</p>
                            </div>
                        </div>
                        <!-- Button -->
                        <div class="pl-lg-4">
